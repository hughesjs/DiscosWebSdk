[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/hughesjs/DiscosWebSdk/dotnet-cd.yml?style=for-the-badge&branch=master)](https://github.com/hughesjs/DiscosWebSdk/actions)
